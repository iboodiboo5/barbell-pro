...
**Highlights:** live workout mode with wall-clock rest timer and PR confetti · per-lift history with 1/3/5RM + estimated 1RM charts · weekly consistency streak and DOTS score · contextual plate calculator · JSON backup/restore (imports v1 data too).
